...
(function () {
    ...
    ***************************************************************************** */
    ...
    var ChildWindowValidationError = /** @class */ (function (_super) {
        __extends(ChildWindowValidationError, _super);
        function ChildWindowValidationError(code) {
            return _super.call(this, code) || this;
        }
        return ChildWindowValidationError;
    }(TestRunErrorBase));
    ...
    var AllowMultipleWindowsOptionIsNotSpecifiedError = /** @class */ (function (_super) {
        __extends(AllowMultipleWindowsOptionIsNotSpecifiedError, _super);
        function AllowMultipleWindowsOptionIsNotSpecifiedError(methodName) {
            var _this = _super.call(this, TEST_RUN_ERRORS.allowMultipleWindowsOptionIsNotSpecifiedError) || this;
            _this.methodName = methodName;
            return _this;
        }
        return AllowMultipleWindowsOptionIsNotSpecifiedError;
    }(TestRunErrorBase));
    ...
    var CloseWindowValidationMessage = /** @class */ (function (_super) {
        ...
        function CloseWindowValidationMessage(windowId) {
    ...
    var SwitchToWindowValidationMessage = /** @class */ (function (_super) {
        ...
        function SwitchToWindowValidationMessage(windowId) {
    ...
    var CloseWindowCommandMessage = /** @class */ (function (_super) {
        ...
        function CloseWindowCommandMessage(windowId) {
    ...
    var SwitchToWindowCommandMessage = /** @class */ (function (_super) {
        ...
        function SwitchToWindowCommandMessage(windowId) {
    ...
    var ChildWindowDriverLink = /** @class */ (function () {
        ...
        ChildWindowDriverLink.prototype.findChildWindows = function (_a, MessageCtor) {
            var windowId = _a.windowId;
            var msg = new MessageCtor(windowId);
            return sendMessageToDriver(msg, this.driverWindow, WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT, CannotSwitchToWindowError);
        };
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        function Driver(testRunId, communicationUrls, runInfo, options) {
            ...
            _this._openWindowPromiseResolveFn = function () { };
        ...
        Driver.prototype._getTargetWindowNotFoundResult = function () {
            return Promise$2.resolve({
                success: false,
        ...
        Driver.prototype._getChildWindowValidateResult = function (arr) {
            ...
            var errItem = arr.find(function (item) { return item.result.errCode === TEST_RUN_ERRORS.cannotCloseWindowWithChildrenError; });
            if (!errItem)
        ...
        Driver.prototype._validateWindow = function (msg, wnd, getWindowFoundResult, WindowValidationMessageCtor) {
            ...
            return Promise$2.all(searchQueries)
                .then(function (arr) {
                return _this._getChildWindowValidateResult(arr);
            });
        };
        ...
        Driver.prototype._closeWindow = function (msg) {
            ...
            if (childWindowToClose) {
                var result = this._createWaitForEventPromise(CHILD_WINDOW_CLOSED_EVENT, CHILD_WINDOW_CLOSED_EVENT_TIMEOUT);
        ...
        Driver.prototype._onWindowOpenCommand = function (command) {
            var _this = this;
            var openWindowPromise = new Promise$2(function (resolve) {
                _this._openWindowPromiseResolveFn = resolve;
        ...
        Driver.prototype._onWindowCloseCommand = function (command) {
            ...
            var targetWindowIsFirstLevelChild = !!this.childWindowDriverLinks.find(function (link) { return link.windowId === command.windowId; });
            var windowId = command.windowId || this.windowId;
        ...
        Driver.prototype._validateChildWindowSwitchToWindowCommandExists = function (windowId, wnd) {
        ...
        Driver.prototype._onSwitchToWindow = function (command) {
            var _this = this;
            var wnd = this.parentWindowDriverLink ? this.parentWindowDriverLink.getTopOpenedWindow() : window;
